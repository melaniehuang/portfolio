...
function preload() {
  paintgif = loadImage("/projects/art/last-machine/data/pour-grey.gif");
  splodge = loadImage("/projects/art/last-machine/data/sLight.png");
  splodge2 = loadImage("/projects/art/last-machine/data/sDark.png");
}
...
function keyPressed() {
  if (keyCode == BACKSPACE) {
    ...
    $("body").append("<img src='/projects/art/last-machine/data/pour-grey.gif'\
                           class='gifPaint'\
                           style='top: " + y + "px;\
                                  left: " + x + "px;\
                                  width: " + w + "px;\
